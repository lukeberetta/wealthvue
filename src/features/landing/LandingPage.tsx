        ...
        <div className="min-h-screen bg-bg text-text-1 selection:bg-accent/20">
            ...
            <main>
                    ...
                    <div className="max-w-[1120px] mx-auto grid lg:grid-cols-2 gap-20 items-center w-full">
                        ...
                        <div className="space-y-8">
                            <motion.div
                                ...
                                className="text-[10px] font-normal tracking-[0.25em] text-accent uppercase"
                            >
                                ...
                                <div className="bg-surface rounded-2xl border border-border overflow-hidden animate-float shadow-2xl">
                                    ...
                                    <div className="bg-surface-2/50 border-b border-border px-5 py-3.5 flex justify-between items-center">
                                        <div className="flex items-center gap-2">
                                            <div className="w-5 h-5 bg-accent rounded flex items-center justify-center text-[10px] text-on-accent font-normal">W</div>
                                            <span className="text-sm font-serif font-normal text-accent">WealthVue</span>
                                        </div>
                                        <div className="bg-surface border border-border rounded-full px-3 py-0.5 text-[10px] font-normal text-text-3">ZAR</div>
                                    </div>
                                    {/* Mockup content */}
                                            ...
                                            {[
                                                ...
                                                <div key={row.t} className="flex items-center justify-between text-[10px] py-2 border-b border-border/40 last:border-0">
                                                    <div className="flex items-center gap-2.5">
                                                        <div className="w-6 h-6 bg-surface-2 rounded-lg flex items-center justify-center font-normal text-text-2 text-[8px]">{row.t[0]}</div>
                                                        <div>
                                                            <p className="font-normal text-text-1">{row.t}</p>
                                                            <p className="text-text-3">{row.n}</p>
                                                        </div>
                                                    </div>
                                                    <div className="text-right">
                                                        <p className="font-normal tabular-nums text-text-1">{row.v}</p>
                ...
                <section id="how-it-works" className="py-32 px-6">
                    <div className="max-w-[1120px] mx-auto">
                        <div className="max-w-xl mb-20 fade-up">
                            <p className="text-[10px] font-normal tracking-[0.22em] text-accent uppercase mb-4">How it works</p>
                ...
                <section className="py-32 px-6 bg-surface-2/20 border-y border-border">
                    <div className="max-w-[1120px] mx-auto">
                        <div className="text-center mb-20 fade-up">
                            <p className="text-[10px] font-normal tracking-[0.22em] text-accent uppercase mb-4">What you can track</p>
                            ...
                            {[
                                {
                                    ...
                                    label: "Screenshot",
                                    preview: <div className="bg-surface-2 p-3 rounded-lg text-[10px] font-normal text-text-2 flex justify-between font-mono">
                                ...
                                },
                                {
                                    ...
                                    preview: <div className="space-y-2">
                                        ...
                                        <div className="bg-accent-light text-accent px-3 py-1.5 rounded-full text-[10px] font-normal inline-flex items-center gap-1.5">
                ...
                <section className="py-32 px-6 bg-surface-2/20 border-y border-border">
                    <div className="max-w-[1120px] mx-auto">
                        <div className="text-center mb-20 fade-up">
                            <p className="text-[10px] font-normal tracking-[0.22em] text-accent uppercase mb-4">Pricing</p>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 max-w-[760px] mx-auto">
                            ...
                            <div className="bg-surface p-10 rounded-2xl border border-border flex flex-col fade-up">
                                ...
                                <button onClick={onTryDemo} className="w-full border border-accent text-accent py-3 rounded-full text-sm font-normal hover:bg-accent-light transition-colors">
                                    Start Free Trial
                                </button>
                            </div>
                            ...
                            <div className="bg-surface p-10 rounded-2xl border border-accent shadow-xl shadow-accent/10 flex flex-col relative fade-up">
                                ...
                                }} className="w-full bg-accent text-on-accent py-3 rounded-full text-sm font-normal hover:opacity-88 transition-all">
                                    Get Started
                                </button>

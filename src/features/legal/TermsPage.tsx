            ...
            <main className="flex-1 max-w-[760px] mx-auto px-6 py-16 w-full">
                ...
                <div className="prose prose-sm max-w-none space-y-10 text-text-2 leading-relaxed">
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">1. Acceptance of Terms</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">2. Description of Service</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">3. Accounts</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">4. Subscription and Billing</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">5. Acceptable Use</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">6. Data and Privacy</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">7. Disclaimer of Warranties</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">8. Limitation of Liability</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">9. Changes to Terms</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">10. Contact</h2>

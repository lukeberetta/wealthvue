    ...
    return (
        <div className="min-h-screen bg-bg text-text-1 flex flex-col">
            ...
            <main className="flex-1 max-w-[760px] mx-auto px-6 py-16 w-full">
                <h1 className="font-serif text-4xl font-normal mb-3">Refund Policy</h1>
                ...
                <div className="prose prose-sm max-w-none space-y-10 text-text-2 leading-relaxed">
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">Our Policy</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">After the Refund Window</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">Cancellations</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">Payment Processing</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="font-serif text-xl font-normal text-text-1">Contact</h2>
